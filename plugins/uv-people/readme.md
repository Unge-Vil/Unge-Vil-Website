...
### 0.8.9
- Updated Team Grid block metadata to `apiVersion: 3` and bumped release to align with the 406 mitigation rollout.
### 0.8.8
- Version bump to align with the UV Core 406 editor hotfix release; no UV People functionality changes.
### 0.8.7
- Version bump for release to support clean upgrade installs (406 hotfix release); no functionality changes.
### 0.8.6
- Version bump to align with the refreshed Experiences cards and login styling; no UV People functionality changes.
### 0.8.5
- Version bump to align with the updated experiences release and team manager tweaks; no UV People functionality changes.
### 0.8.4
- Version bump to align with the updated experiences release; no UV People functionality changes.
### 0.8.3
- Version bump to align with the updated Erfaringer block release; no UV People functionality changes.
### 0.8.2
